...
function DropdownMenuItem({
  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      className={cn(
        'flex cursor-pointer items-center rounded-lg px-3 py-2 text-sm text-secondary outline-hidden select-none focus:bg-state-hove data-[disabled]:pointer-events-none',
        className
      )}
      {...props}
    />
