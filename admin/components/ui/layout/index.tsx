...
function Sidebar({
  ...
  if (collapsible === 'none') {
    return (
      <div data-slot='sidebar' className={cn('flex w-full flex-col', className)} {...props}>
        {children}
      </div>
    );
  }
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          'absolute inset-0 hidden w-(--sidebar-width) transition-[left,right,width] duration-200 ease-linear md:flex',
          side === 'left'
          ...
          variant === 'floating' || variant === 'inset'
            ...
            : 'border-[#1C1F2314] group-data-[collapsible=icon]:w-(--sidebar-width-icon) group-data-[side=left]:border-r group-data-[side=right]:border-l dark:border-[#16161a]',
          className
        )}
        {...props}
      >
