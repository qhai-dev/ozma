...
const buttonVariants = cva(
	"inline-flex shrink-0 cursor-pointer items-center justify-center gap-2 rounded-[3px] text-sm font-semibold whitespace-nowrap text-white transition-all outline-none select-none disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50",
	{
		variants: {
			variant: {
			...
			theme: {
				...
				outline:
					"border-outline-border hover:bg-state-hove rounded-lg border px-2.5 py-1.5 text-sm font-medium",
				ghost: "hover:bg-state-hove rounded-md text-black dark:text-white",
			},
		},
		defaultVariants: {
