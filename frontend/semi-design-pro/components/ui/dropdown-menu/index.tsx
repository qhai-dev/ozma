...
function DropdownMenuItem({
	...
	return (
		<DropdownMenuPrimitive.Item
			...
			className={cn(
				"text-secondary focus:bg-state-hove flex cursor-pointer items-center rounded-lg px-3 py-2 text-sm outline-hidden select-none data-[disabled]:pointer-events-none",
				className,
			)}
			{...props}
		/>
