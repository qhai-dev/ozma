  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          'w-(--sidebar-width) border-sidebar-border hidden h-svh transition-[left,right,width] duration-200 ease-linear md:flex',
          side === 'left'
    ...
    <React.Fragment>
      {
        open ? (
          <Button asChild {...buttonProps}>
            <span className='flex items-center gap-x-3 text-ellipsis whitespace-nowrap'>
              <IconSidebar />
              <span className='flex items-center justify-center'>收起侧边栏</span>
            </span>
          </Button>
        ) : (
          <Tooltip>
...
function SidebarHeader({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      data-sidebar='header'
      className={cn('inline-flex items-center px-2 py-4', className)}
      {...props}
    />
  );
}
