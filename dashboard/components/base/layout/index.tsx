...
function Sidebar({
	...
	if (collapsible === 'none') {
		return (
			<div
				data-slot='sidebar'
				className={cn('flex w-full flex-col bg-sidebar text-sidebar-foreground', className)}
				{...props}
			>
				{children}
			</div>
	...
	return (
		<div
			className='group peer relative hidden h-full bg-amber-300 text-sidebar-foreground md:block'
			data-state={state}
		...
		>
			...
			<div
				...
				className={cn(
					'absolute inset-0 hidden w-(--sidebar-width) bg-red-500 transition-[left,right,width] duration-200 ease-linear md:flex',
					side === 'left'
